 ...
 * @author fkre
 */
public class RequestTargetGender extends RequestEnum<TargetGender>{
     ...
     */
    public RequestTargetGender(String param) {
        super(param);
    }
     ...
     */
    @Override
    protected TargetGender parseValue(String formattedValue) {
        return TargetGender.valueOf(formattedValue);
    }
