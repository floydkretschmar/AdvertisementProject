 ...
 * @author fkre
 */
public class RequestContentFormat extends RequestEnum<ContentFormat>{
     ...
     */
    public RequestContentFormat(String param) {
        super(param);
    }
     ...
     */
    @Override
    protected ContentFormat parseValue(String formattedValue) {
        return ContentFormat.valueOf(formattedValue);
    }
