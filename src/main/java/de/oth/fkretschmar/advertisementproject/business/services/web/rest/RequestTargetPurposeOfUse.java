 ...
 * @author fkre
 */
public class RequestTargetPurposeOfUse extends RequestEnum<TargetPurposeOfUse>{
     ...
     */
    public RequestTargetPurposeOfUse(String param) {
        super(param);
    }
     ...
     */
    @Override
    protected TargetPurposeOfUse parseValue(String formattedValue) {
        return TargetPurposeOfUse.valueOf(formattedValue);
    }
