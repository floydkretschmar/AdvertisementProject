 ...
 * @author fkre
 */
public class RequestTargetMaritalStatus extends RequestEnum<TargetMaritalStatus>{
     ...
     */
    public RequestTargetMaritalStatus(String param) {
        super(param);
    }
     ...
     */
    @Override
    protected TargetMaritalStatus parseValue(String formattedValue) {
        return TargetMaritalStatus.valueOf(formattedValue);
    }
