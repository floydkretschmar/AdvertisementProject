 ...
 *                  repository.
 */
public abstract class AbstractJPASetRepository<T extends IEntity> 
        extends AbstractJPARepository<T, Set<T>> {

    /**
     * Creates a new instance of {@link AbstractJPASetRepository} using the 
     * specified class type.
     * 
     * @param   classType   of the entity being managed by the repository.
     */
    public AbstractJPASetRepository(Class<T> classType) {
        super(classType);
    }    
}
